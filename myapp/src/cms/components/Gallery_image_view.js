...
function Gallery_image_view() {
    ...
    const deleteMinistry = async (id) => {
        try {
            await axios.delete(`http://127.0.0.1:8000/api/galleryimage/${id}/`);
                    ...
                    <tbody>
                        {ministers.map((minister, index) => (
                            <tr key={index}>
                                ...
                                <td>
                                    <p className='fw-normal mb-1'>{minister.heading}</p>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div className='row text-center'>
                                        <div className='col-sm-6'>
                                            <Link className='btn btn-primary m-2' to={`/${minister.id}/galleryimage-edit`}>
...
export default Gallery_image_view;
